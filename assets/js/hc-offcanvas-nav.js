        ...
        n = function (e) {
          if (e.querySelector("ul") || "UL" === e.tagName) {
            var E = "hc-nav-" + ++oe,
              ...
              L = ee.createElement("nav", { id: E }),
              c = ee.createElement("div", { class: "nav-container" });
            ...
            var n,
              ...
              w = !1;
            te.customToggle
              ? (u = ee.getElements(te.customToggle))
              : ((u = [
                  ee.createElement(
                    "a",
                    { href: "#" },
                ...
                e.insertAdjacentElement("afterend", u[0])),
              u &&
                u.length &&
            ...
            var S = function (e, t, n) {
                if (
                  ...
                  if (
                    ...
                    "number" == typeof e
                      ...
                      ie.removeEventListener(s),
                      ie.addEventListener(s, function (e) {
              ...
              j = function () {
                ...
                l.add(
                  ...
                  (L.style.display = ""),
                  (c.style.transition = ""),
                  (n = re.getComputedStyle(c).transitionProperty),
                  (v = ee.toMs(re.getComputedStyle(c).transitionDuration)),
                  (a = re.getComputedStyle(c).transitionTimingFunction),
                  te.pushContent &&
                    f &&
                    n &&
                    l.add(
                      ee.getElementCssTag(f),
                      "transition: " + n + " " + v + "ms " + a
                    ),
                  l.insert();
              },
              r = function (e) {
                var t = !!u && re.getComputedStyle(u[0]).display,
                  n =
                    !!te.disableAt && "max-width: " + (te.disableAt - 1) + "px",
                ...
                L.removeEventListener("click"),
                  ...
                  te.disableBody && L.addEventListener("click", $),
                  e ? j() : setTimeout(j, 0);
              },
              i = function () {
                t = (function c(e, t) {
                        ...
                        : (null !== e.getAttribute("data-nav-active") &&
                          ...
                          Array.prototype.forEach.call(
                            ...
                            function (e) {
                              ...
                              r.length &&
                                (ee.data(e, "hc-uniqid")
                                  ? (i = ee.data(e, "hc-uniqid"))
                                  : ((i = Math.random().toString(36).substr(2)),
                                    ee.data(e, "hc-uniqid", i))),
                                null !== e.getAttribute("data-nav-active") &&
                                  ((m = i),
                ...
                !(function h(n, e, m, b, t, a) {
                  ...
                  if (b && (0 === m || (0 < m && "overlap" === te.levelOpen))) {
                    var i =
                      "string" == typeof b
                        ? b
                        : ee.clone(
                            re.jQuery && b instanceof re.jQuery && b.length
                              ? b[0]
                              : b,
                            !0,
                            !0
                              ...
                              (W()
                                ...
                                : "A" !== r.tagName ||
                                  ...
                                  (null !== r.getAttribute("disabled") &&
                                    "false" !== r.getAttribute("disabled")) ||
                                  r.addEventListener("click", $));
                          var s = ee.createElement("li", { class: "nav-item" });
                          if (
                            (s.appendChild(r),
                            p.appendChild(s),
                            te.keepClasses &&
                            ...
                            if (
                              ...
                              if (
                                ...
                                var f = ee.createElement(
                                  "a",
                                  {
                                    href: "#",
                                    class: "nav-next",
                                    "aria-label":
                                      (te.ariaLabels || {}).submenu + ": " + c,
                                    role: "menuitem",
                                    tabindex: 0,
                                  },
                                  ee.createElement("span")
                                );
                                f.addEventListener("click", ee.preventClick()),
                                  d(f),
                                  te.rtl
                  ...
                  if (
                    ...
                    if (!0 === te.insertBack || 0 === te.insertBack) {
                      var v = ee.createElement("div", { class: "nav-back" }, c);
                      r.insertBefore(
                        v,
                        ee.children(r, ":not(.level-title)")[0]
                      );
                    } else {
                      var u = ee.createElement(
                        "li",
                    ...
                    ee.wrap(
                      ...
                      c.addEventListener("click", ee.preventClick(d)),
                  ...
                  if (0 === m && !1 !== te.insertClose) {
                    ...
                    if (
                      ...
                      r.insertBefore(
                        ee.createElement("div", { class: "nav-close" }, f),
                        r.children[1]
                      );
                    else if (!0 === te.insertClose)
                      r.insertBefore(
                        ee.createElement("div", { class: "nav-close" }, f),
                        r.firstChild
                      );
                  ...
                  ("left" !== te.position && "right" !== te.position) ||
                    ...
                    "doc" === t
                      ? w ||
                        ...
                        ie.addEventListener("touchend", D, ee.supportsPassive))
                      : ((w = !0),
                        c.addEventListener("touchmove", U, ee.supportsPassive),
                        c.addEventListener("touchend", z, ee.supportsPassive)));
                };
              },
              B = function (e, t) {
                re.addEventListener(
                  ...
                  (c.style[ee.browserPrefix("transition")] = "none"),
                  ee.setTransform(c, e, te.position),
                  f &&
                    ((f.style[ee.browserPrefix("transition")] = "none"),
                    ee.setTransform(f, t, te.position));
              },
              q = function (e, t, n, a) {
                void 0 === t && (t = !0),
                  void 0 === n && (n = !1),
                  ...
                  (c.style[ee.browserPrefix("transition")] = ""),
                  ee.setTransform(c, n, te.position),
                  f &&
                    ((f.style[ee.browserPrefix("transition")] = ""),
              ...
              H = function (e) {
                ...
                (t =
                  ...
                  (("left" === te.position && o < 50) ||
                    ("right" === te.position && o > ie.clientWidth - 50)) &&
                    ((T = !0), B(0 - (g - t), Math.abs(t)));
              },
              D = function e(t) {
                if (
                  (ie.removeEventListener("touchmove", H),
              ...
              U = function (e) {
                ...
                if (!(Math.abs(t) < Math.abs(n))) {
                  var a =
                      "overlap" === te.levelOpen ? Y() * te.levelSpacing : 0,
                    r = g + a;
                  (t =
                    "left" === te.position
                    ...
                    (("left" === te.position && t < 0) ||
                      ...
                      ((T = !0), B(-Math.abs(t) + a, r - Math.abs(t)));
                }
              },
              z = function e(t) {
                if (
            ...
            r(),
              ...
              "prepend" === te.bodyInsert
                ? ie.body.insertBefore(L, ie.body.firstChild)
                : "append" === te.bodyInsert && ie.body.appendChild(L),
              !0 === te.expanded && ((h = !0), K()),
              te.swipeGestures &&
                (c.addEventListener("touchstart", _("nav"), ee.supportsPassive),
                ie.addEventListener(
                  "touchstart",
                  _("doc"),
                  ee.supportsPassive
            ...
            var X = function (e, t, n) {
              ...
              if (a) {
                ...
                if (
                  ...
                  -1 !== C.indexOf(r) && C.splice(C.indexOf(r), 1),
                  n &&
                    "overlap" === te.levelOpen &&
                    (s.removeEventListener("click"),
                    s.addEventListener("click", ee.stopPropagation),
                    ee.setTransform(c, (e - 1) * te.levelSpacing, te.position),
                    f))
                ) {
                  var o = "x" === ee.getAxis(te.position) ? g : y;
                  ee.setTransform(
                    f,
                    o + (e - 1) * te.levelSpacing,
                    te.position
                  );
                }
              }
            ...
            return (
              ...
              (L.update = function (e, t) {
                if (((ne = []), "object" == typeof e)) {
                  for (var n in e) te[n] !== e[n] && ne.push(n);
                  te = Object.assign({}, te, e);
                }
                if (!0 === e || !0 === t) {
                  if (te.removeOriginalNav)
          ...
          function K(e, t) {
            if (
              ...
              ((function () {
                ...
                L._eventListeners.toggle &&
                  L._eventListeners.toggle.forEach(function (e) {
                    e.fn(
                      ee.customEventObject("toggle", L, L, { action: "open" }),
                      Object.assign({}, te)
                    );
                  });
                setTimeout(function () {
              ...
              if (
                ...
                m
                  ? ((n = Array.prototype.filter.call(
                    ...
                    (!te.closeActiveLevel && te.closeOpenLevels) || (m = null))
              ...
              else if (!(n = ie.querySelector("#" + E + "-" + e + "-" + t)))
                return void console.warn(
          ...
          function $() {
            if (F()) {
              if (
                ((p = !1),
                f && ee.setTransform(f, !1),
                L.classList.remove(le),
              ...
              L._eventListeners.toggle &&
                L._eventListeners.toggle.forEach(function (e) {
                  e.fn(
                    ee.customEventObject("toggle", L, L, { action: "close" }),
                    Object.assign({}, te)
                  );
                }),
                setTimeout(function () {
                  (L.style.visibility = ""),
                    L._eventListeners.close &&
                      L._eventListeners.close.forEach(function (e) {
                        e.fn(
                          ee.customEventObject("close", L, L),
                          Object.assign({}, te)
                        );
                      }),
                    L._eventListeners["close.once"] &&
                      L._eventListeners["close.once"].forEach(function (e) {
                        e.fn(
                          ee.customEventObject("close.once", L, L),
                          Object.assign({}, te)
                        );
                      }),
          ...
          function R(t, n, e) {
            ...
            if (
              ...
              "overlap" === te.levelOpen &&
                ...
                ee.setTransform(c, t * te.levelSpacing, te.position),
                f))
            ) {
            ...
            L._eventListeners["open.level"] &&
              L._eventListeners["open.level"].forEach(function (e) {
                e.fn(
                  ee.customEventObject("open.level", L, o, {
                    currentLevel: t,
                    currentIndex: n,
                  }),
                  Object.assign({}, te)
          ...
          function Z(t, e) {
            for (var n = t; n <= Object.keys(x).length; n++)
              if (n === t && void 0 !== e) X(t, e, !0);
              else if (0 !== t || te.closeOpenLevels)
                for (var a = 0; a < x[n]; a++) X(n, a, n === t);
              else;
            if (0 < t && L._eventListeners["close.level"]) {
              ...
              L._eventListeners["close.level"].forEach(function (e) {
                e.fn(
                  ee.customEventObject("close.level", L, r, {
                    currentLevel: t - 1,
                    currentIndex: G(),
                  }),
                  Object.assign({}, te)
